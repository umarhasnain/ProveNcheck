export default function RefundPolicy() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 text-gray-800">
      <h1 className="text-3xl font-bold mb-6">ProveNcheck Refund Policy</h1>
      <p className="mb-6">
        At ProveNcheck, we strive to provide accurate and comprehensive vehicle reports to help you make informed
